...
thumbnail: "/images/project/todam-tw/banner.webp"
category: "Web"
startDate: "2024-03"
endDate: "2024-05"
techStack:
...
<TechBadgeGroup badges={["python", "redis", "bedrock", "dynamodb", "lambda", "fastapi", "gradio", "docker"]} />
...
- **Chun-Ho (Hugo) Lin** [Website](https://v0.1chooo.com) | [GitHub](https://github.com/1chooo) | [E-mail](mailto:hugo@v0.1chooo.com)
